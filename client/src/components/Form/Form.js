            ...
            <S.Form action="" onSubmit={handleSubmit}>
                ...
                <S.Flex>
                    ...
                    <div>
                        ...
                        <S.Input required name="email" type="email" placeholder="email@domain.com" onChange={handleChange} value={values.email || ''} />
                        {errors.email && <S.Error>{errors.email}</S.Error>}
                    </div>
                </S.Flex>
                <S.Button type="submit" initial="initial" whileHover={!submitted ? 'hover' : null} whileTap={!submitted ? 'tap' : null} variants={S.buttonVariants} disabled={submitted} submitted={submitted}>
