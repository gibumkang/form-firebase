            ...
            <div className={size.width <= 1100 ? 'table-container' : undefined}>
                ...
                <thead>
                    <tr>
                        ...
                        <S.LogoHeader><img src={allstate} alt="All State" /></S.LogoHeader>
                        <S.LogoHeader><img src={geico} alt="Geico" /></S.LogoHeader>
                        <S.LogoHeader><img src={progressive} alt="Progressive" /></S.LogoHeader>
                    </tr>
                </thead>
                <tbody>
