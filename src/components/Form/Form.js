        ...
        <S.Form action="" onSubmit={handleSubmit}>
            ...
            <S.Flex>
                <div>
                    ...
                    <label htmlFor="name" style={{color: errors.name ? '#cf2317' : '#333'}}>First Name</label>
                    <S.Input 
                        required 
                        name="name" 
                        type="text" 
                ...
                <div>
                    <S.Label htmlFor="dob" triggerError={errors.dob}>Date of Birth</S.Label>
                    <S.Input 
                        required 
                        name="dob" 
            ...
            <S.Flex>
                <div>
                    <S.Label htmlFor="phone" triggerError={errors.phone}>Phone</S.Label>
                    <S.Input 
                        required 
                        name="phone"
                        type="tel"
                ...
                <div>
                    <S.Label htmlFor="email" triggerError={errors.email}>Email</S.Label>
                    <S.Input 
                        required 
                        name="email" 
                        type="email" 
